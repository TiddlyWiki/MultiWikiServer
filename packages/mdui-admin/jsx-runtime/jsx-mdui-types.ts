...
import { MaybeArrayDeep, Ref } from "./jsx-utils";

interface HTMLElementProps<T> extends Omit<HTMLAttributes<T>, "style">, JSX.IntrinsicAttributes {
  ref?: Ref<T extends Element ? T : never>;
}

export interface MDUI_Elements {
  /**
  * Avatar Component 
  * 
  * ```html
  ...
  */
  ...
  'mdui-bottom-app-bar': {
    ...
    */
    ...
    /**
      ...
      */
    'order'?: number;
  } & HTMLElementProps<mdui.BottomAppBar>;
  /**
  ...
  } & HTMLElementProps<mdui.ButtonIcon>;
  /**
    * Button Component 
   * 
   * ```html
  ...
  'mdui-checkbox': {
    ...
    */
    ...
    /**
      ...
      */
    'tabindex'?: number;
  } & HTMLElementProps<mdui.Checkbox>;
  /**
    * Chip Component 
   * 
   * ```html
  ...
  'mdui-circular-progress': {
    ...
    */
    ...
    /**
      ...
      */
    'value'?: number;
  } & HTMLElementProps<mdui.CircularProgress>;
  /**
  ...
  } & HTMLElementProps<mdui.CollapseItem>;
  /**
  ...
  'mdui-collapse': {
    ...
    */
    ...
    /**
      ...
      */
    'disabled'?: boolean;
  } & HTMLElementProps<mdui.Collapse>;
  /**
    * Dialog Component 
   * 
   * ```html
  ...
  } & HTMLElementProps<mdui.Dropdown>;
  /**
   ...
   * * `right`: Positions the component on the right.
    ...
    */
    ...
    /**
      ...
      */
    'order'?: number;
  } & HTMLElementProps<mdui.LayoutItem>;
  /**
  ...
  } & HTMLElementProps<mdui.LayoutMain>;
  /**
    * Layout Component 
   * 
   * ```html
  ...
  'mdui-linear-progress': {
    ...
    */
    ...
    /**
      ...
      */
    'value'?: number;
  } & HTMLElementProps<mdui.LinearProgress>;
  /**
  ...
  'mdui-list-item': {
    ...
    */
    ...
    /**
      ...
      */
    'tabindex'?: number;
  } & HTMLElementProps<mdui.ListItem>;
  /**
  ...
  } & HTMLElementProps<mdui.ListSubheader>;
  /**
  ...
  'mdui-menu-item': {
    ...
    */
    ...
    /**
      ...
      */
    'tabindex'?: number;
  } & HTMLElementProps<mdui.MenuItem>;
  /**
  ...
  'mdui-navigation-bar-item': {
    ...
    */
    ...
    /**
      ...
      */
    'tabindex'?: number;
  } & HTMLElementProps<mdui.NavigationBarItem>;
  /**
  ...
  'mdui-navigation-bar': {
    ...
    */
    ...
    /**
      ...
      */
    'order'?: number;
  } & HTMLElementProps<mdui.NavigationBar>;
  /**
  ...
  'mdui-navigation-drawer': {
    ...
    */
    ...
    /**
      ...
      */
    'order'?: number;
  } & HTMLElementProps<mdui.NavigationDrawer>;
  /**
  ...
  'mdui-navigation-rail-item': {
    ...
    */
    ...
    /**
      ...
      */
    'tabindex'?: number;
  } & HTMLElementProps<mdui.NavigationRailItem>;
  /**
  ...
  'mdui-navigation-rail': {
    ...
    */
    ...
    /**
      ...
      */
    'order'?: number;
  } & HTMLElementProps<mdui.NavigationRail>;
  /**
  ...
  'mdui-radio-group': {
    ...
    */
    ...
    /**
      ...
      */
    'required'?: boolean;
  } & HTMLElementProps<mdui.RadioGroup>;
  /**
  ...
  'mdui-range-slider': {
    ...
    */
    ...
    /**
      ...
      */
    'name'?: string;
  } & HTMLElementProps<mdui.RangeSlider>;
  /**
  ...
  'mdui-segmented-button-group': {
    ...
    */
     ...
     * Note: The HTML attribute is always a string and can only be set as an initial value when `selects="single"`. The JavaScript property is a string when `selects="single"` and an array of strings when `selects="multiple"`. In `selects="multiple"`, this value can only be modified by changing the JavaScript property.
      ...
      */
    'value'?: string | string[];
  } & HTMLElementProps<mdui.SegmentedButtonGroup>;
  /**
  ...
  'mdui-segmented-button': {
    ...
    */
     ...
     * **Note**: Only available when `href` is not specified and `type="submit"`.
      ...
      */
    'formtarget'?: '_self' | '_blank' | '_parent' | '_top';
  } & HTMLElementProps<mdui.SegmentedButton>;
  /**
  ...
  } & HTMLElementProps<mdui.Snackbar>;
  /**
    * Switch Component 
   * 
   * ```html
  ...
  'mdui-tab-panel': {
    ...
    */
    'value'?: string;
  } & HTMLElementProps<mdui.TabPanel>;
  /**
   ...
   * * `outlined`: Text field with border, providing a subtler visual effect.
    ...
    */
    ...
    /**
      ...
      */
    'tabindex'?: number;
  } & HTMLElementProps<mdui.TextField>;
  /**
    * Tooltip Component 
   * 
   * ```html
  ...
  } & HTMLElementProps<mdui.TopAppBarTitle>;
  /**
   ...
   * * `large`: Large-sized app bar.
    ...
    */
    ...
    /**
      ...
      */
    'order'?: number;
  } & HTMLElementProps<mdui.TopAppBar>;
}
