...
function l(e, t, n) {
  ...
  if (c !== o) {
    (c !== 0 && (e = e.slice(c)),
      (r = n(r, o, (o = c + e.length * 3), 1) >>> 0));
    const i = h().subarray(r + c, r + o),
      g = L(e, i);
    ((c += g.written), (r = n(r, o, c, 1) >>> 0));
  }
  return ((f = c), r);
}
let a = null;
function s() {
  return (
    (a === null ||
      a.buffer.detached === !0 ||
      (a.buffer.detached === void 0 && a.buffer !== _.memory.buffer)) &&
      (a = new DataView(_.memory.buffer)),
    a
  );
}
function w(e) {
...
class R {
  ...
  compile(t) {
    const n = l(t, _.__wbindgen_malloc, _.__wbindgen_realloc),
      o = f,
      r = _.querycompiler_compile(this.__wbg_ptr, n, o);
    if (r[2]) throw x(r[1]);
    return x(r[0]);
  }
  compileBatch(t) {
...
function k(e, t) {
  const n = String(t),
    o = l(n, _.__wbindgen_malloc, _.__wbindgen_realloc),
    r = f;
  (s().setInt32(e + 4 * 1, r, !0), s().setInt32(e + 4 * 0, o, !0));
}
function C(e) {
  return e.buffer;
}
...
function ye(e, t) {
  global.PRISMA_WASM_PANIC_REGISTRY.set_message(p(e, t));
}
function me() {
...
function $e(e, t) {
  ...
  (s().setFloat64(e + 8 * 1, b(o) ? 0 : o, !0),
    s().setInt32(e + 4 * 0, !b(o), !0));
}
function Ve(e) {
  return e;
}
function We(e, t) {
  ...
  var r = b(o) ? 0 : l(o, _.__wbindgen_malloc, _.__wbindgen_realloc),
    u = f;
